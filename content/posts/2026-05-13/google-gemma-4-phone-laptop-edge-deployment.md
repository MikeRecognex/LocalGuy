---
title: "BT Explainer: Google's Gemma 4 Could Put Powerful AI on Your Phone and Laptop"
date: 2026-05-13
...
This release also intensifies competition in the open-source LLM space and accelerates innovation in tooling around models optimised for edge inference. Projects like [Ollama](https://ollama.ai/) and [llama.cpp](https://github.com/ggerganov/llama.cpp) will benefit from having a new, well-resourced baseline model to optimise around, while users gain another high-quality option for local deployment.
