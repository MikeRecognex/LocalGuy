---
title: "Using a local iPhone MCP server to plan Apple Watch workouts with Codex"
date: 2026-07-01
...
source:
  name: "Hacker News"
  url: "https://bernhardhering.de/blog/ask-my-health-codex-workout-plan/"
status: published
---
...
For local LLM practitioners, this provides a concrete template for iOS deployment. The project demonstrates that consumer devices now have sufficient computational resources to host both the inference engine and agent infrastructure. [Read the full technical writeup](https://bernhardhering.de/blog/ask-my-health-codex-workout-plan/) to understand the implementation details and adapt the pattern for other local agent applications.

---
*Source: [Hacker News](https://bernhardhering.de/blog/ask-my-health-codex-workout-plan/) · Relevance: 8/10*
